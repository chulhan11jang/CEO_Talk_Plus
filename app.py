...
with tab3:
    groups = {
        "1조": ["조지태", "권명재", "김동휘", "김무성", "김병두", "김지수", "김현준", "박경택", "손영락", "이종일", "이종일", "이지명", "이형섭", "정중환", "조영찬", "최진호"],
        "2조": ["이동훈", "나원일", "박재만", "강태규", "구교현", "김광수", "김기현", "김도형", "김재동", "박정현", "이선규", "이진업", "장두희", "허선"],
        "3조": ["이동훈", "유인수", "장승우", "백남산", "김성훈", "박무룡", "유기주", "유선수", "전희진", "조성재"],
        "4조": ["이동훈", "유인수", "장승우", "백남산", "김성훈", "박무룡", "유기주", "유선수", "전희진", "조성재"],
        "5조": ["이동훈", "유인수", "장승우", "백남산", "김성훈", "박무룡", "유기주", "유선수", "전희진", "조성재"],
    }
