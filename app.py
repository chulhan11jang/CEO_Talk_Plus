...
<li>조원 모두가 한 번의 기회를 가지며 '골인' 성공 개수로 점수를 획득합니다.</li>
<li>우리 조가 많은 '골인'을 할 수 있도록 열렬히 응원하며 목표에 도전합니다.</li>
</ul>

<b>🎯 Game Tip</b><br>

<ul>
<li>발 안쪽의 넓은 부위로 차면 보다 정확하게 찰 수 있습니다.</li>
<li>너무 강하게 차기보다 적당한 힘으로 정확하게 차는 것이 중요합니다.</li>
<li>골대를 보기보다 공을 끝까지 바라보며 차보세요.</li>
</ul>

<b>😊 참고해 주세요</b><br>

<li>Goal-In은 정확도와 집중력이 필요한 게임입니다.</li>
...
st.markdown("---")
st.caption("CEO Talk Plus · Mobility Solution / 문의 : 장철한 선임 (010-3476-6176)")
