...
""", unsafe_allow_html=True)
    ...
    <b>⚽ 목표 달성 'Goal-In'</b><br><br>

    • 조별로 진행되는 가벼운 축구 Activity입니다.<br>
    • 제한 시간 내 골을 성공시키면 점수를 획득합니다.<br>
    • 조원 모두가 함께 참여하며 협력과 응원을 통해 목표에 도전합니다.<br><br>

    <b>🎯 Game Tip</b><br><br>

    • 발 안쪽의 넓은 부위로 차면 방향을 잡기 쉽습니다.<br>
    • 너무 강하게 차기보다 적당한 힘으로 정확하게 차는 것이 중요합니다.<br>
    • 골대를 보기보다 공을 끝까지 바라보며 차보세요.<br>
    • 앞선 참가자의 성공과 실패를 참고하면 성공 확률이 높아집니다.<br><br>

    <b>😊 참고해 주세요</b><br><br>

    • Goal-In은 정확도와 집중력이 필요한 게임입니다.<br>
    • 누구나 한 번에 성공하기는 어렵습니다.<br>
    • 성공 여부와 관계없이 조원들과 함께 도전하고 응원하는 시간을 즐겨주시기 바랍니다.
