...
<div class="info-row-last">
    ...
    <div class="info-value">
        ...
        <span style="color:#D32F2F;">정문 15:35</span>
    </div>
</div>
...
with tab3:
    groups = {
        "1조": ["조지태", "권명재", "김동휘", "김무성", "김병두", "김지수", "김현준", "박경택", "이종일", "이지명", "이형섭", "정중환", "조영찬", "최진호"],
        "2조": ["이동훈", "나원일", "박재만", "강태규", "구교헌", "김광수", "김기영", "김도형", "김재동", "박정현", "이선규", "이진업", "장두희", "허선"],
...
<img src="https://raw.githubusercontent.com/chulhan11jang/CEO_Talk_Plus/main/dinner4.png"
     style="width:100%;
            margin-top:0px;
            border-radius:12px;
            border:1px solid #E7E7E7;">
